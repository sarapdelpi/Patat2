...
//PETICION HTTP PARA BUSCAR PRODUCTOS
    const handleSearch = async(e) => {
        ...
        try{
            const response = await fetch(`http://imagenback:8080/producto/buscar`, {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        ...
        const fetchTodos = async() => {
            ...
            try{
                const response = await fetch(`http://imagenback:8080/producto/inicio/${localStorage.getItem('correo_usuario')}`, {
                    method: "GET",
                    headers: {
                    "Content-Type": "application/json",
                    }
